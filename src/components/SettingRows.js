...
class SettingRows extends Component {
	constructor(props) {
		super(props);
		console.log('!!!', this.props.intervals.morningCurrentLower);
	}
  ...
  _rowOnPress(evt: Object, props: Object) {
    this.props.navigator.push({
      ...
      title: evt.label,
      passProps: Object.assign({}, props, {intervalKey: evt.value}),
    });
  }
  ...
  render() {
    ...
    return (
      ...
      {this.populateIntervalSettingItem(this.props.intervals)}
      </TableView.Section>
